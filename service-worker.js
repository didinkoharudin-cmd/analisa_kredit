const CACHE = 'analisis-kredit-pwa-V18.3.11.156-safe-fill-on-nav-only';
const SHELL=['./','./index.html','./score-v156.css?v=156','./score-header-v137.js?v=137','./score-header-background-v137.jpg?v=137','./score-logo-white-compact.png','./score-icon-192.png','./score-icon-512.png',
