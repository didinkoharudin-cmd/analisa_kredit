const CACHE = 'analisis-kredit-pwa-V18.3.11.134-score-home';
const SHELL=['./','./index.html','./score-v134.css','./score-logo-white.png','./score-icon-192.png','./score-icon-512.png',
