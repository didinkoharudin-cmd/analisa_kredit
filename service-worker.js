const CACHE = 'analisis-kredit-pwa-V18.3.11.150-blue-tuned-to-header';
const SHELL=['./','./index.html','./score-v150.css?v=150','./score-header-v137.js?v=137','./score-header-background-v137.jpg?v=137','./score-logo-white-compact.png','./score-icon-192.png','./score-icon-512.png',
