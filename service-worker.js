const CACHE = 'analisis-kredit-pwa-V18.3.11.76.1-web-push-fix-home-klasemen';
...
self.addEventListener('push',event=>{
  ...
  const options={body:String(data.body||''),icon:data.icon||'./icon-192.png',badge:'./icon-192.png',tag:data.tag||undefined,renotify:false,data:data.data||{},timestamp:Date.now()};
