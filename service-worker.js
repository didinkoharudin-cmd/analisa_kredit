const CACHE = 'analisis-kredit-pwa-V18.3.11.110-customer-care-style';
const SHELL=['./','./index.html','./customer-care-v109.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./offline.html'];
