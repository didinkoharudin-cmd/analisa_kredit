const CACHE = 'analisis-kredit-pwa-V18.3.11.115-bundling-interactive-promo-share';
const SHELL=['./','./index.html','./android-back-v111.js','./customer-care-v109.js','./bundling-g6b-g2c-v115.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./offline.html'];
