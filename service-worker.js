const CACHE = 'analisis-kredit-pwa-V18.3.11.118-flexible-unit-booking';
const SHELL=['./','./index.html','./android-back-v111.js','./customer-care-v109.js','./bundling-g6b-g2c-v117.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./offline.html'];
