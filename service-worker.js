const CACHE = 'analisis-kredit-pwa-V18.3.11.114-bundling-renewal';
const SHELL=['./','./index.html','./android-back-v111.js','./customer-care-v109.js','./bundling-g6b-g2c-v114.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./offline.html'];
