const CACHE = 'analisis-kredit-pwa-V18.3.11.112-mobile-back';
const SHELL=['./','./index.html','./android-back-v111.js','./customer-care-v109.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./offline.html'];
